...
<img data data-hash="product-1" class="product__big__img" src="img/product/details/product-1.jpg" alt=""/>
...
<div class="product__item__pic set-bg" style={{backgroundImage:'url(img/product/related/rp-1.jpg)'}}>
...
<div class="col-lg-3 col-md-4 col-sm-6">
<div class="product__item">
<div class="product__item__pic set-bg" style={{backgroundImage:'url(img/product/related/rp-2.jpg)'}}>
<ul class="product__hover">
...
<div class="col-lg-3 col-md-4 col-sm-6">
<div class="product__item">
<div class="product__item__pic set-bg" style={{backgroundImage:'url(img/product/related/rp-3.jpg)'}}>
...
<div class="col-lg-3 col-md-4 col-sm-6">
<div class="product__item">
<div class="product__item__pic set-bg" style={{backgroundImage:'url(img/product/related/rp-4.jpg)'}}>
<ul class="product__hover">

...
<div class="categories__item categories__large__item set-bg" style={{backgroundImage: 'url(img/categories/category-1.jpg)'}} >
...
<div class="categories__item set-bg" style={{backgroundImage: 'url(img/categories/category-2.jpg)'}} >
<div class="categories__text">
<h4>Men’s fashion</h4>
<p>358 items</p>
<a href="#">Shop now</a>
...
<div class="product__item__pic set-bg" style={{backgroundImage: 'url(img/product/product-1.jpg)'}} >
...
<div class="product__item">
<div class="product__item__pic set-bg" style={{backgroundImage: 'url(img/product/product-2.jpg)'}} >
<ul class="product__hover">
...
<div class="product__item">
<div class="product__item__pic set-bg" style={{backgroundImage: 'url(img/product/product-3.jpg)'}} >
...
<div class="product__item">
<div class="product__item__pic set-bg" style={{backgroundImage: 'url(img/product/product-4.jpg)'}} >
<ul class="product__hover">
...
<div class="product__item">
<div class="product__item__pic set-bg" style={{backgroundImage: 'url(img/product/product-5.jpg)'}} >
<ul class="product__hover">
...
<div class="product__item__pic set-bg" style={{backgroundImage: 'url(img/product/product-6.jpg)'}} >
...
<div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
<div class="product__item">
<div class="product__item__pic set-bg" style={{backgroundImage: 'url(img/product/product-7.jpg)'}} >
<ul class="product__hover">
...
<div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
<div class="product__item sale">
<div class="product__item__pic set-bg" style={{backgroundImage: 'url(img/product/product-8.jpg)'}} >
...
<section class="banner set-bg" style={{backgroundImage: 'url(img/banner/banner-1.jpg)'}} >
<div class="container">
<div class="row">
